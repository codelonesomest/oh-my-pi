 ...
 *
 * Dispatches a {@link streamSimple}-shaped request to an `pi auth-gateway`
 ...
 * containerized pi deployments (robomp slots, the swarm extension) that
...
/**
 * Stream a turn through an `pi auth-gateway` over the pi-native protocol.
 *
