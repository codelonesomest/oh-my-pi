 ...
 * (containerized pi, the swarm extension, robomp's sidecar auth-gateway).
 ...
 * `SimpleStreamOptions` from older / newer pi builds without per-version
 * conditionals.
 */
 ...
 * targets (containerized pi → host gateway, robomp slot → omp-auth-gateway
