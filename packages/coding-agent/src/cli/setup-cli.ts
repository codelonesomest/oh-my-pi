 ...
 *
 * Handles `pi setup` for onboarding and `pi setup <component>` for optional dependencies.
 */
...
// package dependencies beyond a working interpreter. `pi setup python --check`
...
/**
 * Unified `pi setup speech` flow. Drives every {@link SpeechComponent} through
