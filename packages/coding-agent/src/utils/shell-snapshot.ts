...
${fnEnvHelper}
printf '%s\\n' "$__pi_funcs" | __pi_emit_referenced_exports >> "$SNAPSHOT_FILE"
unset -f __pi_sq_quote __pi_emit_export_for __pi_emit_referenced_exports 2>/dev/null
unset __pi_funcs __pi_qbuf __pi_qout __pi_sq __pi_xv __pi_name 2>/dev/null
