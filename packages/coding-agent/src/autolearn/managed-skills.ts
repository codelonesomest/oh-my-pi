 ...
 * isolated directory (`~/.pi/agent/managed-skills`) separate from
 * user-authored skills (`~/.pi/agent/skills`). They are discovered and
...
/** Resolve the isolated managed-skills directory (`~/.pi/agent/managed-skills`). */
