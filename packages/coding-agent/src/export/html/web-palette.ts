/**
 * Web/export palette — the pi brand identity shared by the collab-web live
 * client (`my.pi.sh/`) and every public HTML export / share viewer (`/s/<id>`).
 *
 ...
 * colors for every pi user. The public web artifacts want the collab-web
