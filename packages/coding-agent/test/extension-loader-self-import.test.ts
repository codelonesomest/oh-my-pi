...
declare global {
	var __piHostPiForLoaderIdentityTest: typeof PiCodingAgent | undefined;
}
...
describe("extension loader host runtime binding", () => {
	...
	beforeEach(() => {
		...
		globalThis.__piHostPiForLoaderIdentityTest = PiCodingAgent;
	});

	afterEach(() => {
		projectDir?.removeSync();
		projectDir = undefined;
		globalThis.__piHostPiForLoaderIdentityTest = undefined;
	});
	...
	const identityGuard = `
		const expectedPi = globalThis.__piHostPiForLoaderIdentityTest;
